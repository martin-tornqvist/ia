...
{
public:
    Door(const Pos& pos, const Rigid* const mimic_feature,
    ...
    Feature_id get_id() const override {return Feature_id::door;}
    ...
    const Rigid* get_mimic() const {return mimic_feature_;}
