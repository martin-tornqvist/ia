...
PlayerBonusHandler::PlayerBonusHandler(Engine* engine) : eng(engine) {
  ...
  setBonus(playerBonus_mobile, "Mobile", "Every second move is a free action", playerBonus_lithe, playerBonus_tough);
...
//  setBonus(playerBonus_quick, "Quick", "10% chance for free turn when moving");
  ...
  setBonus(playerBonus_stealthy, "Stealthy", "+45% chance to avoid being spotted by monsters");
  setBonus(playerBonus_imperceptible, "Imperceptible", "+20% chance to avoid being spotted by monsters", playerBonus_stealthy, playerBonus_dexterous);
  setBonus(playerBonus_occultist, "Occultist", "Casting chance of memorized spells increases over time");
  setBonus(playerBonus_warlock, "Warlock", "+20% chance to cast memorized spells, can disarm magic traps", playerBonus_occultist, playerBonus_strongMinded);
  ...
  setBonus(playerBonus_selfAware, "Self-aware", "Cannot be confused, number of remaining turns for status effects is displayed", playerBonus_strongMinded, playerBonus_observant);
