...
void MapBuildSpawnItems::spawnItems() {
    ...
    nrOfSpawns += static_cast<double>(nrOfSpawns) * (static_cast<float>(eng->player->getInstanceDefinition()->abilityValues.getAbilityValue(ability_searching, false)) / 100) * 2;
