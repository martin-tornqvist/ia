...
void init_data_list()
{
    ...
    d.melee.prop_applied = new PropPoisoned(PropTurns::specific, poison_dmg_n_turn * 4);
    data[(size_t)d.id] = d;
    ...
    d.melee.prop_applied = new PropPoisoned(PropTurns::specific, poison_dmg_n_turn * 2);
    data[(size_t)d.id] = d;
