...
void FeatureDataHandler::initDataList() {
  ...
  d.color = clrGray;
  d.tile = tile_wallTop;
  d.isBodyTypePassable[actorBodyType_normal] = false;
  d.isBodyTypePassable[actorBodyType_ethereal] = true;
  d.isBodyTypePassable[actorBodyType_flying] = false;
  d.isBodyTypePassable[actorBodyType_ooze] = false;
  ...
  d.isBodyTypePassable[actorBodyType_normal] = false;
  d.isBodyTypePassable[actorBodyType_ethereal] = true;
  d.isBodyTypePassable[actorBodyType_flying] = true;
  d.isBodyTypePassable[actorBodyType_ooze] = false;
  d.isShootPassable = false;
  d.isVisionPassable = false;
  ...
  d.isBodyTypePassable[actorBodyType_normal] = false;
  d.isBodyTypePassable[actorBodyType_flying] = true;
  d.isBodyTypePassable[actorBodyType_ooze] = true;
  d.isBodyTypePassable[actorBodyType_ethereal] = true;
  d.isShootPassable = true;
  d.isVisionPassable = true;
  d.canHaveBlood = false;
  ...
  d.isBodyTypePassable[actorBodyType_normal] = true;
  d.isShootPassable = true;
  d.isVisionPassable = true;
  d.canHaveBlood = false;
  d.canHaveGore = false;
